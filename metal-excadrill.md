...
>
> Fox's Metal deck, built for the card shop. Every card carries regulation mark H, I, or J, so it is legal exactly as it sits. The whole list exists to solve one problem: put five Energy on one Pokémon before the opponent takes three Prizes.
>
> Nothing metal was in the binders when this was planned, so this is the only deck in the house that was bought from zero. The Trainer shell came from the shared box; the Pokémon did not. Game words are defined in [the table rules](./rules.md).
...
>
> **Pokémon** — [Mega Excadrill ex](#mega-excadrill-ex) · [Drilbur](#drilbur) · [Metang](#metang) · [Beldum](#beldum) · [Genesect ex](#genesect-ex) · [Fezandipiti ex](#fezandipiti-ex)
> **Supporters** — [Lillie's Determination](#lillies-determination) · [Boss's Orders](#bosss-orders) · [Philippe](#philippe) · [Brock's Scouting](#brocks-scouting) · [Drayton](#drayton)
> **Items** — [Ultra Ball](#ultra-ball) · [Buddy-Buddy Poffin](#buddy-buddy-poffin) · [Mega Signal](#mega-signal) · [Night Stretcher](#night-stretcher) · [Switch](#switch) · [Energy Recycler](#energy-recycler) · [Prime Catcher](#prime-catcher)
> **Tool / Stadium** — [Full Metal Lab](#full-metal-lab)
> **Energy** — [Magnetic Metal Energy](#magnetic-metal-energy) · [Basic Metal Energy](#basic-metal-energy)
>
...
*Maximum Drilling* costs three Metal Energy and does 200 damage. Attach two more and it does 330.

| Energy on Excadrill | Maximum Drilling |
| :--- | ---: |
| 3 | 200 |
| 4 | 200 |
| 5 or more | **330** |
...
> [!IMPORTANT]
> **Excadrill is a Stage 1, so this deck runs no Rare Candy.** Mega Chandelure and the Gengars need Candy because they are Stage 2. Drilbur evolves straight into the Mega. That is four slots the other Mega decks in this house do not get back, and it is why this list can afford four Metang.
...
**Stage 1 from Drilbur. Gives up 3 Prize cards.** 340 HP, Retreat 4, Fire Weakness, and a Grass Resistance of 30 that quietly matters more than it looks.

*Maximum Drilling* is [M][M][M] for 200, plus 130 more when at least two extra Energy are attached. Five Energy total, 330 damage, every turn, with no cooldown and no self-discard. Nothing about the attack punishes you for using it twice in a row, which separates this card from most big attackers in the format.

*Undermine* is [M][M] for 90 and discards the top two cards of the opponent's deck. It is the turn-two attack while you are still counting to five, and the mill is not a win condition; treat those two cards as a rounding error you get for free.
...
**Retreat 4 is the worst number on the card**, and it is the reason both Magnetic Metal Energy and two Switch are in the list. Read [game plan 4](#4-magnetic-metal-is-the-anti-lantern-card) before you sleeve it.

### Drilbur

The Basic the deck stands on, and the Pitch Black print specifically. Four other Drilbur are Standard legal and the other four are worse here.
...
**The engine, and the only card in this deck that is not replaceable.** Four copies, and it is the Temporal Forces print. The Chaos Rising and Journey Together Metang have no Ability at all and do not serve this line.
...
70 HP, Poffin-legal, Retreat 1, and its entire job is becoming Metang. Four copies, because the Bench wants three Metang standing for the whole game and the line cannot afford to draw the wrong half. *Headbutt* does 10 damage and you will never use it.

### Genesect ex

**The search engine and the plan B in one Basic.** 220 HP, Retreat 2.
...
Switch in 1 of your opponent's Benched Pokémon to the Active Spot. Three copies. 330 damage is only worth what it is aimed at, and the games this deck loses are the ones where the opponent parks a cheap wall out front and rebuilds behind it. The Ghetsis print, shared across every deck in the house.

### Philippe

> Attach up to 2 Basic Metal Energy cards from your discard pile to 1 of your Metal Pokémon.

**The rebuild card.** When a loaded Excadrill dies, five Energy hit the discard pile at once, and the deck's whole problem starts over from zero. Philippe puts two of them straight back onto the next one, which turns a two-turn rebuild into a one-turn rebuild. Two copies, and it is the most underrated card in the list.

It reads "your Metal Pokémon," so it can never target Drilbur. Evolve first, then Philippe.

### Brock's Scouting

Search your deck for up to 2 Basic Pokémon or 1 Evolution Pokémon. Two copies. Early it fetches Drilbur and Beldum together; late it fetches the Excadrill that Genesect already used its Ability for this turn. One card that answers both halves of the curve is worth more than a second copy of either specialist.

### Drayton

Look at the top 7 cards of your deck and take a Pokémon and a Trainer from them. One copy, and it is the flex Supporter. It digs seven deep in a deck where the top four are already spoken for by Metal Maker, and it is the first slot [Test and Tune](#test-and-tune) trades away.
...
Discard 2 cards from your hand, then search your deck for any Pokémon. Four copies. The discard is close to free in this deck and occasionally a bonus, because Energy in the discard pile is exactly what Philippe and Night Stretcher want to find there.

### Buddy-Buddy Poffin

Search your deck for up to 2 Basic Pokémon with 70 HP or less and bench them. Drilbur is 70 and Beldum is 70, so both halves of the deck's opening are always live targets and Poffin is never a dead card on turn one. Three copies, shared with three other decks in the box.

### Mega Signal

Search your deck for a Mega Evolution Pokémon ex. Two copies, and it is the reason three Excadrill is enough. Straight, unconditional, no discard, no cost. The house owns one already.

### Night Stretcher

Put a Pokémon **or a basic Energy card** from your discard pile into your hand. Both halves matter here. The dead Excadrill comes back, and so does the basic Metal that went down with it. It can never touch Magnetic Metal Energy, because special Energy stays where it falls.

### Switch

Switch your Active Pokémon with 1 of your Benched Pokémon. Two copies, which is one more than most decks in this house run, and Retreat 4 is the reason. The more common emergency is not Excadrill being stuck, it is a gusted Metang sitting Active for a turn while your engine idles.

### Energy Recycler

Shuffle up to 5 Basic Energy cards from your discard pile into your deck. One copy. Metal Maker reads the top four cards of your library, so its hit rate is a function of how much Metal is still in there. Late game this card is not recovery, it is a reload for the engine.
...
**The Fire patch, and it is the only one this deck gets.** The reduction is applied after Weakness, which is exactly the order that saves you: a 170-damage Fire attack doubles to 340 and kills a healthy Excadrill on the nose, and Full Metal Lab drops it to 310. Two copies, because the opponent will play their own Stadium over it and you need the second one to put it back.
...
**Two copies, and this is the most important tech card in the house.** It fixes Retreat 4 for free while still counting as one of the five Energy that Maximum Drilling needs, so it costs the deck literally nothing to run.

What it does to [the lantern deck](./psychic-lanterns.md) is covered in [game plan 4](#4-magnetic-metal-is-the-anti-lantern-card) and it is worth reading before the next kitchen-table night.
...
**Eleven copies, and the count is load-bearing rather than arbitrary.** Metal Maker looks at four cards and attaches whatever Metal it finds, so the density of basic Metal in the library is directly the engine's throughput. Eleven in sixty works out to roughly one hit per look, which is what makes three Metang worth three Energy a turn.

This is the number [Test and Tune](#test-and-tune) watches hardest, in both directions. Basic Energy never rotates and any English print is legal.
...
> [!WARNING]
> **Metal Maker and Philippe both read "Basic Metal Energy."** Neither one can touch Magnetic Metal Energy, and Night Stretcher and Energy Recycler cannot either. Every extra special Energy you add is a card the engine cannot see. Two is the cap for a reason.
...
| :--- | :--- | ---: | :--- |
| Undermine | [M][M] | 90 | nothing; it is the turn-two placeholder |
| Maximum Drilling, 3 or 4 Energy | [M][M][M] | 200 | the small support Pokémon |
| Maximum Drilling, 5 Energy | [M][M][M] | **330** | Dragapult ex and nearly every two-Prize ex |
| Protect Charge (Genesect ex) | [M][M][C] | 150 | the one-Prize bodies, off a two-Prize attacker |
...
- **Fire decks** cash it in one hit, not two. That is the Stadium's whole job.
- **Two Excadrill on the board at once** hands them six Prizes in four hits. Never bench the second one until the first is spent.
...
## 3. Count to five before you swing
...
## 4. Magnetic Metal is the anti-lantern card

[Mega Chandelure ex](./psychic-lanterns.md) does 130 damage plus 50 more for each Colorless in your Active Pokémon's Retreat Cost, and its *Binding Flame* Ability adds one to that cost from anywhere on the board.
...
## 5. Losing Excadrill is not losing the game
...
| Symptom | Fix |
| --- | --- |
| Never reaching five Energy by turn three | 12th basic Metal over Drayton; bench Metang before Genesect |
| Flooding on Energy in hand | cut to 10 basic Metal for a 3rd Brock's Scouting; Metal Maker pulls from the deck, not the hand |
| Excadrill dies before it attacks twice | lead with Genesect ex; keep the second Excadrill off the board |
| Losing to Fire | 2 Iron Defender over Drayton and a Switch |
| Metang keeps getting gusted and stranded | 3rd Switch over the Energy Recycler |
| The rebuild after a knockout keeps whiffing | 3rd Philippe over Drayton |
| Whiffing the Mega itself | 3rd Mega Signal over Drayton |
...
Own counts are live from the collection database. The Trainer shell is mostly already in the box and shared with the other sleeved decks, so check [the box](./collection.md) before ordering; the Pokémon are all new, because the binders had no Metal cards in them at all.

```buy
Mega Excadrill ex | Pitch Black 065 | 3 | Double Rare; 065, never the 103 collector print
Drilbur | Pitch Black 046 | 4 | the Call for Family print; the other four legal Drilbur do not serve this line
Metang | Temporal Forces 114 | 4 | the Metal Maker print; the Chaos Rising and Journey Together copies have no Ability
Beldum | Chaos Rising 059 | 4 |
Genesect ex | Black Bolt 067 | 2 | Double Rare; 067, not the 161 or 169 prints
Fezandipiti ex | Shrouded Fable 038 | 1 | shared with the Mega Gengar deck, which runs 2
Lillie's Determination | Mega Evolution 119 | 4 | shared
Boss's Orders | Mega Evolution 114 | 3 | shared; the Ghetsis print
Philippe | Chaos Rising 079 | 2 | the rebuild card; 079, not 110
Brock's Scouting | Journey Together 146 | 2 |
Drayton | Surging Sparks 174 | 1 | the flex slot; first thing Test and Tune trades away
Ultra Ball | Mega Evolution 131 | 4 | shared
Buddy-Buddy Poffin | Temporal Forces 144 | 3 | shared
Mega Signal | Mega Evolution 121 | 2 | shared
Night Stretcher | Shrouded Fable 061 | 2 | shared
Switch | Mega Evolution 130 | 2 | shared
Energy Recycler | Destined Rivals 164 | 1 | 164, not the Perfect Order 108 collector print
Prime Catcher | Prismatic Evolutions 119 | 1 | ACE SPEC; contested with two other sleeved decks
Full Metal Lab | Temporal Forces 148 | 2 | the fire patch; two, because they will play over it
Magnetic Metal Energy | Chaos Rising 085 | 2 | Special Energy; nothing recovers it once discarded
Basic Metal Energy | Mega Evolution Energies 008 | 11 | never rotates; the count is load-bearing
```

> [!IMPORTANT]
> **Regulation clock.** Everything here is Standard legal as of August 2026. The core is young: Pitch Black and Chaos Rising are Reg J with years left. The H cards are the ones on the clock and they rotate around April 2027, which in this list means Metang, Full Metal Lab, Buddy-Buddy Poffin, Night Stretcher, Drayton, Fezandipiti ex, and Prime Catcher. **Metang is the one that hurts**, because Metal Maker is the deck and no legal reprint exists yet. Watch for one.
