...
> [!IMPORTANT]
> **On hold until the Gnawing Curse pair arrives.** This build needs 2 Gengar ex (Temporal Forces 104); the pair was ordered 2026-08-20 and is in the mail. The dark ex deck that is buildable today is [Snake Charmer](./dark-mega.md), an eighteen-card mode swap on [Gengar Gang Classic](./dark-classic.md), and its second build already claims one of the two Gengar ex for its ghost toolbox. This plan comes off hold when the envelope lands and the sleeves get sorted.

> [!NOTE]
> **What this file is for.**
>
> A complete, Standard-legal 60. Every engine runs at full count, the only 1-ofs are generic outs, and the centerpiece is something no tournament list currently plays.
>
> Two parts matter more than the list itself.
>
> - **[The prize ladder](#the-prize-ladder)**, which is the reason the deck exists.
> - **[Game plan 1](#1-two-ghosts-one-line)**, the deck's identity: build a different Gengar depending on who sits across the table.
>
> Game words are defined in [the table rules](./rules.md). The ex-format habits live in [How To Play ex Style](./rules.md#how-to-play-ex-style).
...
>
> **Pokémon** — [Gastly](#gastly) · [Haunter](#haunter) · [Gengar ex](#gengar-ex) · [Mega Gengar ex](#mega-gengar-ex) · [Munkidori](#munkidori) · [Fezandipiti ex](#fezandipiti-ex) · [Sableye](#sableye) · [Toxel](#toxel) · [Toxtricity](#toxtricity)
> **Supporters** — [Lillie's Determination](#lillies-determination) · [Dawn](#dawn) · [Boss's Orders](#bosss-orders)
> **Items** — [Buddy-Buddy Poffin](#buddy-buddy-poffin) · [Rare Candy](#rare-candy) · [Ultra Ball](#ultra-ball) · [Night Stretcher](#night-stretcher) · [Energy Switch](#energy-switch) · [Switch](#switch) · [Prime Catcher](#prime-catcher)
> **Stadium** — [Risky Ruins](#risky-ruins)
...
Three findings drove this build, and each one is checkable.

**The standalone Mega Gengar box loses.** Its record on [Limitless online play](https://play.limitlesstcg.com/decks/mega-gengar-ex?format=standard) is 2 wins against 17 losses. The card wins events only as a package inside N's Zoroark ex or Marnie's Grimmsnarl ex shells. Building "Mega Gengar plus one-prize Darkness attackers" and expecting tournament results is betting against the data.

**Standard holds a second ex Gengar, and nobody plays it.** Gengar ex from Temporal Forces carries *Gnawing Curse*, which puts 2 damage counters on any Pokémon your opponent attaches an Energy to from hand. It appears in zero decklists in the [Limitless main database](https://limitlesstcg.com/cards/TEF/104). It is a different card name from Mega Gengar ex, so the two share one Haunter line and separate 4-copy limits.

**A quarter of the field turns Shadowy Concealment off.** Festival Lead, Slowking, Alakazam, Dhelmise, and Toucannon together hold roughly 25% of the [current meta](https://play.limitlesstcg.com/decks?game=PTCG&format=standard), and they attack with single-prize Pokémon precisely to blank abilities like Concealment. Gnawing Curse fires against every deck that attaches Energy from hand, which is all of them.
...
> [!IMPORTANT]
> **Format check, August 2026.** Standard is regulation marks **H, I, and J**. Every card in this list carries one of the three, verified against the legal pool snapshot. The 15 reg-H cards (Gengar ex, Munkidori, Fezandipiti ex, Buddy-Buddy Poffin, Night Stretcher, Prime Catcher) rotate around April 2027.
...
> [!WARNING]
> **One ACE SPEC per deck, total.** Prime Catcher is this deck's one. Legacy Energy, Scramble Switch, Maximum Belt, and Hero's Cape all want the slot; the swap notes in [game plan 6](#6-things-that-will-cost-you-a-game) say when each one wins the argument.
...
The Basic everything is built on, and deliberately the **Phantasmal Flames print**, because Gengar Gang runs the Perfect Order print and both decks stay sleeved. Same 70 HP, so it stays a legal Buddy-Buddy Poffin target.

### Haunter

***Haunt* places 3 damage counters for one Energy**, and placed counters ignore Weakness and Resistance. Haunter is not a stage this deck skips lightly; before Rare Candy arrives, a 100 HP body dropping 3 counters a turn is the chip engine already running. Every counter it places is one more the [kill math](#3-the-counter-economy) does not have to find later.

### Gengar ex

**The sleeper card.** Stage 2 from Haunter, 310 HP, gives up 2 Prizes. No tournament list plays it, which is exactly why it is interesting; it answers the matchup the Mega cannot touch.
...
***Tricky Steps* is disruption wearing a damage number.** 160, and you may move an Energy from their Active to 1 of their Benched Pokémon, and you choose which one. Send it to a draw engine or a support piece and the Energy is functionally discarded. They re-attach from hand; the Curse bites again. That loop is [game plan 2](#2-the-curse-toll).
...
**Stage 2 from Haunter. Gives up 3 Prizes.** Unlike the XY-era "M" cards, playing it does not end your turn; it evolves like any other Stage 2 ([Bulbapedia](https://bulbapedia.bulbagarden.net/wiki/Mega_Gengar_ex_(Phantasmal_Flames_56))).
...
**Monkey business.** *Adrena-Brain* moves up to 3 damage counters from one of your Pokémon to one of your opponent's, once per turn, while Munkidori has Darkness Energy attached. Each copy carries its own once-per-turn, so two in play move 6 and three move 9. At one copy an engine like this is a hope; at three it is the deck's second attack.
...
*Flip the Script* draws 3 whenever one of your Pokémon was Knocked Out on their last turn, and this deck plans to lose a cheap body most turns. Two copies, because the draw engine of a trading deck cannot live in the Prizes one game in ten.
...
Search your deck for a Basic, a Stage 1, and a Stage 2, all three to hand. In this deck Dawn is not just the line assembler, it is the **mode selector**: the Stage 2 slot fetches whichever Gengar the matchup wants. Ex deck across the table, take the Mega. Single-prize deck, take the Curse. Dawn is the play when the board is behind and the hand is fine; Lillie's is the play when the hand is the problem.
...
Bench up to 2 Basic Pokémon with 70 HP or less from the deck. Here that means Gastly and Toxel, the bottoms of both engines. Sableye at 80, Munkidori at 110, and Fezandipiti at 210 all miss the cap; Toxel's *Call for Family* and Ultra Ball pick up what Poffin cannot lift. Four copies because turn one wants two seeds down.

### Rare Candy

Gastly straight to either Gengar. Two riders: not on your first turn, and not on a Basic that came into play this turn. Three copies rather than four, because Haunter is a real stage in this deck; *Haunt* opens the chip math while the Candy waits.

### Ultra Ball

Discard 2 other cards from your hand, then search your deck for any Pokémon. The unconditional search that lifts what Poffin cannot: Munkidori, Sableye, Fezandipiti, and both Gengars. The discard is a real price; pitch spare Energy and late-game Poffins, not attackers, and remember Night Stretcher reads the discard pile.

### Night Stretcher

Put a Pokémon or a basic Energy card from your discard pile into your hand. Three copies, because this deck plans to lose a body nearly every turn and runs only 2 copies of each Gengar; the third copy of either ghost is the one you get back.

### Energy Switch

Moves a basic Energy between your Pokémon. This is Munkidori's second fuel line: *Sinister Surge* charges a Benched Darkness Pokémon from the deck, Energy Switch relays it to Munkidori, and your hand attachment stayed free for the front. Two copies because the engine it feeds runs at three.

### Switch

One copy, and it is a generic out rather than a strategy card. Both Gengars retreat for 2, and the deck no longer runs a pivot Pokémon; when a wall gets gusted up or stranded, this is the cheap answer that is not the ACE SPEC.
...
> If 1 of your Darkness Pokémon is Knocked Out **by damage from an attack from your opponent's Pokémon ex**, that player takes 1 fewer Prize card. The effect doesn't stack.
...
> [!WARNING]
> **Read the trigger twice.** The Knock Out must come from an attack, by a Pokémon ex. Against a deck that attacks with non-ex Pokémon, *Shadowy Concealment* does nothing at all. This deck builds a different Gengar for those games; that is [game plan 1](#1-two-ghosts-one-line).
...
they re-attach         --Gnawing Curse-->   2 more counters
```

Tricky Steps' move is optional and targeted, and that is the whole trick. Send their Energy to a draw engine or a support Pokémon and it is functionally discarded; they either leave it stranded or pay the toll again to rebuild the Active. Against attackers with two- and three-Energy costs, you are deleting a turn of their development per attack while a 310 HP wall soaks whatever they send back.
...
- **230 + 90 = 320.** Void Gale plus three Adrena-Brains, one turn. That is a Dragapult ex, exactly.
- **160 + 40 + 90 = 290.** Tricky Steps plus two Curse ticks plus the Munkidori line. Most Stage 1 and Stage 2 ex die inside two turns of this without the Mega ever fighting.
- **100 + whatever is lying there.** Cruel Arrow reaches the Bench, and the Bench is where Curse and Ruins counters accumulate. Check their damaged sitters before every attack; the snipe KO is free Prizes.
- **Two Void Gales = 460.** Nothing printed survives it, and at 350 HP the Mega usually survives the turn in between.
...
Do the prize map in both directions before every trade, the way [the rules](./rules.md#how-to-play-ex-style) teach.
...
| Your hand has | Play |
| :--- | :--- |
| **Buddy-Buddy Poffin** | Play it first, always. Fetch **Gastly and Toxel**, the bottoms of both engines. |
| **A workable board + Dawn** | **Dawn.** Gastly, Toxtricity, and the Gengar the matchup wants, read from what they benched. |
| **A bad hand** | **Lillie's Determination** for 8. The bonus dies with your first Prize; spend it while it is live. |
| **Toxel, going second** | Bench everything, Toxel Active, ***Call for Family*** for Munkidori plus Sableye. The engines are on the board before turn two. |
| **Gastly and a Gengar in hand** | Bench the Gastly and wait. Rare Candy is illegal turn one and illegal on a Basic benched this turn. |
...
| :--- | :--- |
| Building the Mega against a single-prize deck | Concealment is blank and you volunteered a 3-Prize body. Build the Curse; the ladder does not apply to them. |
| Splitting Candy between both Gengars early | Two half-built ghosts, no wall, no toll. Commit first, diversify later. |
| Expecting Surge to fuel Munkidori | Illegal. Surge reads Darkness and Munkidori is Psychic. Energy Switch, hand attachment, or Void Gale are the routes. |
| Adrena-Brain with no Darkness Energy on that Munkidori | The ability checks **each copy separately**. Three Munkidori need three Energies before all three guns fire. |
| Poffin targeting Sableye or Munkidori | Illegal, 80 and 110 HP against a 70 cap. *Call for Family* and Ultra Ball are the routes. |
| Rare Candy on a Basic that Poffin benched this turn | Illegal. Bench your Basics one turn earlier than you think you need them. |
| Tricky Steps moving Energy onto their real attacker | The move is optional and you pick the target. A bench-sitter or nothing. |
| Risky Ruins before benching Munkidori | Your own Stadium taxes your Psychic engine 20. Munkidori first, Ruins after, when the choice exists. |
| Letting the last Fezandipiti die with the draw engine on | Flip the Script is the deck's late-game Supporters. Under Concealment it costs them almost nothing to leave alone, so they will Boss it; keep its retreat paid. |
| Spending Prime Catcher as a plain Switch | It is the only gust that also fixes your position. The plain Switch exists so this card can wait for the double play. |
| Forgetting the Curse taxes only hand attachments | Ability and Trainer acceleration pays no toll. Count their engine before you count on the tax. |

---

## The Meta This Deck Lives In

Current Standard, per [Limitless play data](https://play.limitlesstcg.com/decks?game=PTCG&format=standard), August 2026, 367 tournaments and 61,966 matches.
