...
>
> A house deck for game night, built by welding the Team Rocket engine onto your Dark Box. It is not tournament-shaped and it does not need to be. Every card is legal at the kitchen table, including the Japanese prints you already own.
>
> The two halves are not a theme. They solve each other's problems. Mega Gengar ex taxes every Prize the table takes off a Darkness Pokémon, and the Team Rocket Crobat line is the only attacker on this side of the room that is not Fighting weak.
...
> - [Deck List](#deck-list)
> - [Why Each Package Is Here](#why-each-package-is-here)
> - [Key Card Text](#key-card-text)
> - [The Prize Map](#the-prize-map)
...
**Two Darkness Stage 2 lines share one engine, and the engine costs nothing extra.**
...
> [!IMPORTANT]
> **Team Rocket's Mewtwo ex is not in this deck, on purpose.**
>
> *Power Saver* shuts it off unless you have 4 or more Team Rocket's Pokémon in play, and half this board is Gengar. Mewtwo is also Psychic, so *Shadowy Concealment* does nothing for it. It is the wrong card for a hybrid, and it is Fox's card anyway. Leave it in his deck.
...
> [!WARNING]
> **Legacy Energy is the one ACE SPEC.** You own a Japanese Prime Catcher and an English Scramble Switch. Either can take the slot instead. Never two of them.
...
**Energy.** 9 basic Darkness carries Mega Gengar's [D][D] and Seviper's [D][D][D]. 2 Team Rocket's Energy each pay for a full *Assassin's Return* on their own. 1 Legacy Energy is the ACE SPEC.
...
The hybrid's whole argument in one card. 310 HP on a Stage 2 that gives up 2 Prizes, weak to Lightning rather than Fighting.

- ***Biting Spree*** triggers when you play it from your hand to evolve, including off Rare Candy. 2 damage counters on each of two of their Pokémon. Bench targets are legal, so it reaches things a gust cannot.
- ***Assassin's Return*** [D][D] for 120, then optionally back to your hand with everything attached discarded. The damage on it goes to the discard too.

The bounce is a heal, an escape, and a reset of *Biting Spree* all at once. The cost is the Energy, so bounce off basic Darkness when you plan to do it, and save Team Rocket's Energy for turns you intend to stay.

### Team Rocket's Golbat

*Sneaky Bite* puts 2 damage counters on one of their Pokémon when you evolve into it. Free, and it stacks with everything else on this page. 80 HP means it does not want to be Active.

### Team Rocket's Zubat

50 HP, so Buddy-Buddy Poffin gets it. *Poison Spray* costs one Darkness and needs no damage roll, which is occasionally the right turn-one play.

### Seviper

***Excited Power*** reads "in play," not "Active." Mega Gengar ex on the Bench turns *Pitch-Black Fangs* into 240 damage for one Prize. This is the best trade available to you and the reason the Mega is worth building even on turns it never attacks.

### Team Rocket's Proton

The one Supporter in this deck you may play on your first turn when you go first. It only finds Basic Team Rocket's Pokémon, which here means Zubat, and that is exactly the piece that is hardest to draw naturally.

### Team Rocket's Giovanni

A gust and a self-switch in one card, gated on your Active being a Team Rocket's Pokémon. Perfect for the turn Crobat is stuck Active and you want Seviper in front instead.

### Team Rocket's Energy

Provides 2 Energy in any mix of Psychic and Darkness, and attaches only to Team Rocket's Pokémon. One card fully pays for *Assassin's Return*. It cannot go on Gengar, Seviper, or Sableye, and Night Stretcher cannot get it back.

### Risky Ruins

Places 2 damage counters on any Basic non-Darkness Pokémon a player benches during their turn. Your ten Basics are all Darkness, so you are exempt and Fox is not. It does not trigger on the opening setup, only on Bench drops made during a turn, which in practice means every Poffin, Nest Ball, and hand drop he makes for the rest of the game.

### Legacy Energy

Provides one Energy of any type, and takes one Prize away from whoever knocks out the Pokémon holding it, once per game. Stacking it with *Shadowy Concealment* is the point. See the Prize map.
...
| Source | Cost | Damage |
| --- | --- | --- |
| Mega Gengar ex, *Void Gale* | [D][D] | 230, and moves 1 Energy to your Bench |
| Seviper, *Pitch-Black Fangs* with a Darkness Mega in play | [D][D][D] | 240 |
| Team Rocket's Crobat ex, *Assassin's Return* | [D][D] | 120 |
| Sableye, *Cocky Claw* with a Stage 2 Darkness benched | [D] | 90 |
| Haunter, *Haunt* | [D] | 30, placed as counters |
...
### 1. Poffin turn one, Candy turn two
...
### 5. Sableye is the turn-two attacker
...
### Fox's Ground Zero, Mega Zygarde ex
...
- Crobat ex takes a flat 200 and lives at 110, then bounces to your hand at full health.
- Mega Zygarde ex is a Pokémon ex, so *Shadowy Concealment* is on all game. Your Seviper trades 0 Prizes for his 3.
- Mega Zygarde ex is a Basic non-Darkness Pokémon, so Risky Ruins taxes it 20 every time he benches one during a turn.
- He needs two knockouts to lose. You need three, and Concealment means several of yours are free.

### Fox's Team Rocket's Mewtwo deck
...
**Seviper sits at two Energy.** If *Pitch-Black Fangs* is a turn late every game, the Energy river is not running. Add 2 Energy Switch over 1 Night Stretcher and 1 Punk Helmet, or add the Toxel and Toxtricity line from [Dark Box](./dark-curse.md) if you want real acceleration and are willing to cut four Trainer slots for it.
