...
> **Items:** [Rare Candy](#rare-candy) · [Buddy-Buddy Poffin](#buddy-buddy-poffin) · [Poke Pad](#poke-pad) · [Switch](#switch) · [Energy Recycler](#energy-recycler)
...
**250 HP Basic, Fighting Weakness, Retreat 3.** The shield, and on Live the most dependable early attacker in the deck.

***Poisonous Musculature* costs [C].** It searches up to two Basic Darkness Energy out of the deck, attaches them to the dog, and Poisons it. One Energy from your hand becomes three on the board, which is the best Energy deal in the format. Take both, every time.

***Chain-Crazed* does 130, and 130 more while this Pokémon is Poisoned.** That is 260 for [D][D][C], and 520 into anything weak to Darkness. It one-shot a Dhelmise, a Spiritomb, and a Mew ex on Live, and it does the same to Alakazam, Munkidori, and Jellicent ex.
...
70 HP, which keeps it inside Poffin and Poke Pad range. It is Darkness, so Risky Ruins never touches it and Janine's can feed it.
...
**Two copies, and two jobs.** It is the no-Candy route, since Gastly to Haunter to Gengar ex needs only time. It is also the safe step, turning an exposed Gastly into a 100 HP, one-Prize Haunter that becomes a Gengar next turn.
...
**Stage 2, 280 HP, Fighting Weakness, Retreat 2. 30th Celebration 090, mark J.** The deck.

***Chaotic Pain* costs [D][D] and places 13 damage counters on 1 of your opponent's Pokémon.** [Who Chaotic Pain hits](#who-chaotic-pain-hits) has the target order.

**280 HP has a band.** It survives every hit at 270 or under, including *Phantom Dive* at 200, *Nebula Beam* at 210, *Vengeful Anchor* at 170, and a bare *Aura Jab* at 260. It dies to everything at 380 or over, like *Gaia Wave* at 400 through Weakness and *Mega Brave* at 540. The hits in between are what [Hero's Cape](#heros-cape) is for.

***Fainting Spell* flips a coin when this Pokémon is Knocked Out by damage from an attack, and on heads the Attacking Pokémon is Knocked Out too.** It works against any attacker, ex or not. On Live it took a Mega Zygarde, a Mega Floette, and a Dhelmise. [When to stand and when to pull](#when-to-stand-and-when-to-pull) has the rule.

Three copies, because this is the card that attacks, and so the card that dies.

### Mega Gengar ex

**Stage 2 from Haunter. 350 HP. Gives up 3 Prizes, or 2 once its own Ability applies.**
...
***Void Gale* does 230 for [D][D] and moves an Energy to a Benched Pokémon.** It is the finisher when no Gengar ex is up. Boss's Orders a target, Switch in the Mega, attach, and swing. That line closed the Charizard game on Live. It doubles to 460 into anything weak to Darkness, the one number *Chaotic Pain* can't reach, because counters ignore Weakness.

**The Cape makes it 450**, the only body in the deck that survives Mega Zygarde's 400. Nothing survives *Mega Brave* at 540.

### Toxel

***Call for Family* benches two Basic Pokémon from the deck for [D].** It reaches Okidogi ex, which Poffin and Poke Pad can't.
...
***Sinister Surge* attaches a Basic Darkness Energy from the deck to a Benched Darkness Pokémon once a turn, and puts two damage counters on it.** It is an Ability, so it works on turns your Supporter is busy.

Two copies, and each Surges on its own; the card carries no "you can't use more than one" clause. Grimsley's and Poke Pad both find it, and it has no Candy clock, so it never needs the turn-1 search. [Where the Energy goes](#where-the-energy-goes) covers the targets.

> [!CAUTION]
> **The two damage counters have a breakpoint.** A bare Gengar ex at 280 survives a bare *Aura Jab* at 260, and one Surge makes that exactly lethal. Under the Cape a Surged Gengar is 360, which still clears Jab plus Premium Power Pro at 320 and *Maximum Drilling* at 330, but not Drilling with Kieran at 360. **Against Fighting and Metal, feed the dogs and never the ghosts.**
...
**Shuffle your hand into your deck and draw six, or eight while you still hold all six Prizes.** Three copies.
...
Lillie's went from four to three for the second Boss's Orders. [Test and Tune](#test-and-tune) has the fourth.

### Grimsley's Move

**Look at the top 7 cards of your deck and put a Darkness Pokémon you find there onto your Bench. You can't use this card during your first turn.** Two copies, Phantasmal Flames 090, mark I. Both copies in the sleeve are the player's-choice stamped holos from the last two league nights, and those two prizes are why this card got a look at all.
...
| Toxtricity | a Surge the same turn, since it arrives on the Bench |
| Gengar ex | a second attacker, arriving empty; Surge and your attachment arm it |
| Okidogi ex | the shield, when no dog opened |
| Haunter or Gastly | next turn's Gengar, or a fresh Candy target |

The odds, and when to play it, are in [Grimsley's Move odds](#grimsleys-move-odds). The six cards it passes over go to the bottom of your deck and stay there until something shuffles.

### Dawn

**Search your deck for a Basic, a Stage 1, and a Stage 2 Pokémon.** Two copies. One card sets up a whole line: Gastly, Haunter, and a Gengar, or Toxel, Toxtricity, and a Gengar.

**Its Stage 2 pick is the matchup call**, from [Which Stage 2 gets the Candy](#which-stage-2-gets-the-candy). When Grimsley's is the plan for the Mega, take Gengar ex with Dawn and leave the Mega in the deck.

### Hilda

**Search your deck for an Evolution Pokémon and an Energy card.** Two copies. It is the Energy-in-hand card for the 26% of hands that open without one, and it reads *Evolution Pokémon*, which here is nine cards: two Haunter, three Gengar ex, two Mega Gengar ex, and two Toxtricity.
...
**Search your deck for a Trainer card.** Two copies. It makes every one-of behave like a two-of.
...
**Choose up to two of your Darkness Pokémon. For each, search your deck for a Basic Darkness Energy and attach it. If one was your Active Pokémon, it is now Poisoned.** One copy, mark H.
...
> [!NOTE]
> **TCG Live now plays it as printed.** Live used to force one Energy onto your Active and one onto your Bench. A September 2026 update fixed that, so two Benched Pokémon work online too, and your Active is Poisoned only when it takes one of the Energy.

### Boss's Orders

**Switch in 1 of your opponent's Benched Pokémon to the Active Spot.** Two copies, up from one.

*Chaotic Pain* does most of a gust's job for free. The reasons to drag are the ones counters can't cover:

- **Munkidori.** It is weak to Darkness, so once it is Active any real attack kills it, even an un-Poisoned *Chain-Crazed*. You don't need a Gengar in play to answer it.
- **A target behind Battle Cage**, which protects their Bench and nothing else.
- **The last Prize.** A damaged body or a Pokémon ex on their Bench, for a dog or *Void Gale*.
- **An attacker they just loaded**, stranded in the Active Spot.

> [!WARNING]
> **Don't Boss while a Mega Lucario ex that just used *Mega Brave* is Active.** Its lockout is an effect of the attack, and it comes off the moment the Lucario leaves the Active Spot. Sending it to the Bench hands them a fresh 540 a turn early, and Lucario decks carry Air Balloon to bring it straight back.

### AZ's Tranquility

**Switch your Active Pokémon with one of your Benched Pokémon. If the one you moved to the Bench is a Pokémon ex, heal 80 damage from it.** One copy, Chaos Rising 076, mark J.
...
- **It is the Mega's return ticket.** *Void Gale*, take the hit, and AZ's it home with Concealment still on.
...
**Four copies.** Five Stage 2 cards sit over four Gastly, and Candy is the speed route. Two timing rules decide openings: never on your first turn, and never on a Basic that entered play this turn. **Search first, then Candy.**

### Buddy-Buddy Poffin

**Two Basic Pokémon with 70 HP or less, straight to the Bench.** Gastly and Toxel are the targets. It is the only Item that benches two on turn 1, and the only way to fill the Bench going first. Two copies, mark H; Poke Pad is its April replacement.

### Poke Pad

**Search your deck for a Pokémon without a Rule Box.** Two copies, printed Poké Pad, Perfect Order 081, mark J, and reprinted in 30th Celebration.
...
**Switch your Active Pokémon with one of your Benched Pokémon.** Two copies. Retreat Costs are paid in Energy, and this board's are 3 and 2; Switch pays in a card instead. It also clears Poison, so spend it on the ghosts, not on a Poisoned dog.

### Energy Recycler

**Shuffle up to 5 Basic Energy cards from your discard pile into your deck.** Two copies.
...
**The Pokémon this card is attached to gets +100 HP.** The ACE SPEC, Temporal Forces 152, mark H.
...
> [!WARNING]
> **Jamming Tower turns it off.** Two Risky Ruins are the answer, and replacing the Tower the turn before their hit is the whole reason to hold one.

### Risky Ruins

**Two damage counters on every Basic non-Darkness Pokémon either player benches.** Every Pokémon here is Darkness, so it is completely one-sided. The 20 stays through evolution, which is what puts Alakazam and Crustle inside one *Chaotic Pain*.
...
> [!NOTE]
> **Against Dragapult your Ruins is usually unplayable, and that's fine.** Most Dragapult lists run Risky Ruins themselves, and theirs does nothing to an all-Darkness Bench.
...
| Board, against a Pokémon ex attacker | What it pays them |
| :--- | ---: |
| Mega Gengar ex, Gengar ex, Okidogi ex, Toxtricity, Gastly | 2 + 1 + 1 + 0 + 0 = **4** |
| Gengar ex, Okidogi ex, Toxtricity, Gastly, with no Mega | 2 + 2 + 1 + 1 = **6**, the whole game |
| Mega Gengar ex, two Gengar ex, Okidogi ex, Toxtricity | 2 + 1 + 1 + 1 + 0 = **5** |
| Two Mega Gengar ex, two Gengar ex, Okidogi ex | 2 + 2 + 1 + 1 + 1 = **7** |
...
| | |
| :--- | ---: |
| Cost of letting a Gengar ex die, with the Mega on the Bench | **1 Prize** |
...
> [!CAUTION]
> **Concealment only covers Knock Outs by damage from an attack by a Pokémon ex.** It does nothing against:
>
> - single-Prize attackers like Dhelmise, Alakazam, Slowking, Crustle, and Spiritomb.
> - counters placed by an attack, like *Powerful Hand*, *Spiritual End*, *Matcha Spin*, and the Bench half of *Phantom Dive*.
> - counters moved by an Ability. Munkidori silences *Fainting Spell* too.
> - Poison and other damage between turns.
>
> In those rooms you are a midrange deck in an honest Prize race, and the Mega stays in the deck.
...
1. **Grimsley's Move, from your second turn.** Straight from the deck to the Bench, with no Gastly or Candy spent. Count the targets first; [the odds table](#grimsleys-move-odds) has the numbers.
...
The exceptions are in [Which Stage 2 gets the Candy](#which-stage-2-gets-the-candy). Never build it against single-Prize attackers, build Gengar ex first against Munkidori, and build the Cape'd Gengar ex first against Mega Lucario.

## 5. When the dog gets gusted
...
## 6. Choosing the stadium

Two Risky Ruins, and Petrel works like a third, so the question is usually when, not which. [Risky Ruins](#risky-ruins) has the table of what to replace.

- **Lead it against evolution decks.** The 20 on every Basic they bench carries through evolution.
- **Hold one for Battle Cage, Gravity Mountain, or Jamming Tower**, and replace them the turn before they matter.
- **Against four-copy Stadium decks, treat it as a tax.** Beedrill has to play a Forest every turn to keep going; make it spend one.
- **Against Dragapult, don't bother.** Their Ruins blocks yours by name and does nothing to your Bench.
- **Against Neutralization Zone, replace it once.** It is an ACE SPEC and can't come back.

## 7. Bench discipline

Keep the board's payout at four or less against ex attackers.

- One Mega Gengar ex, never two.
- One dog in play. The second waits until the first is gone.
- At most two other Pokémon ex.
- A spare Gastly, because that is next turn's Gengar. Against *Jetting Blow* and *Phantom Dive*, bench small Basics only when they evolve next turn.
- Against Judge, Special Red Card, and Unfair Stamp, bench what you draw. Hands full of held Pokémon got shuffled away in the N's Zoroark, Mega Lucario, and Toxtricity Box games.

## 8. When the Cape goes on
...
| Deck | Share | Section |
| :--- | ---: | :--- |
| Dragapult ex, every build | ~19%, and Steve most weeks at league | [Versus Dragapult ex](#versus-dragapult-ex) |
| Alakazam, both builds | ~7.5% | [Versus Alakazam](#versus-alakazam) |
| N's Zoroark ex | 6.1% | [Versus N's Zoroark ex](#versus-ns-zoroark-ex) |
...
| Beedrill ex | 0.8% | [Versus Beedrill ex](#versus-beedrill-ex) |
| Toxtricity Box | 0.6% | [Versus Toxtricity Box](#versus-toxtricity-box) |
| Cinccino ex | 0.2%, and seen at league | [Versus Cinccino ex](#versus-cinccino-ex) |
| Mega Zygarde ex, Mega Floette ex, Charizard | on the Live ladder | [Zygarde](#versus-mega-zygarde-ex), [Floette](#versus-mega-floette-ex), [Charizard](#versus-charizard-and-battle-cage) |

### Versus Dragapult ex

| Their number | Your answer |
| :--- | :--- |
| *Phantom Dive*: 200 to the Active, and 6 counters across your Bench | Gengar ex at 280 survives the 200. The 6 counters kill a 70 HP Basic that already carries a Surge. |
| Dreepy 70, Drakloak 90, Munkidori 110, Budew 30 | one *Chaotic Pain* each |
| Dragapult ex, 320 HP | two dog swings, or *Void Gale* plus a Pain |
...
- **Munkidori first, Budew second.** *Itchy Pollen* locks your Items for a turn, and AZ's is the rotation that still works under it.
...
| Their number | Your answer |
| :--- | :--- |
| *Aura Jab*: 130 for one Energy, 260 into your Fighting Weakness, 320 with Premium Power Pro | the Cape'd Gengar ex at 380 survives it |
| *Mega Brave*: 270 for two Energy, 540 into your Weakness, never two turns running | nothing survives it; stand and die for the coin |
| Riolu 80, Lunatone 110, Solrock 110 | one *Chaotic Pain* each |

- **Kill every Riolu,** and the Mega never arrives.
- **This is the one ex room where the Mega waits.** They run three Boss's Orders and a 540 attack, so a parked Mega is 2 Prizes they can drag up and take. Build the Cape'd Gengar ex first, and take the Mega only when Haunter hands it over.
- **Don't Boss while a Lucario that just used *Mega Brave* is Active.** Sending it to the Bench wipes the lockout, and Air Balloon brings it back fresh.
- **Gravity Mountain** takes 30 off every Stage 2. Replace it the turn before the Jab, not the turn it lands.
- **Judge is common here.** Bench what you draw.

### Versus Mega Zygarde ex

| Their number | Your answer |
| :--- | :--- |
| *Gaia Wave*: 200 for three Energy, 400 into your Fighting Weakness, and 30 less damage to it next turn | everything dies to it except a Cape'd Mega Gengar at 450 |
| Rocky Fighting Energy | *Chaotic Pain* can't touch the Zygarde holding it |
...
- **Mega first, and the Cape goes on it.** Every Knock Out they took in the Live loss would have cost one Prize less, and their 6 would have been 2. A Cape'd Gengar ex at 380 still dies to 400.
- **Search before you Candy.** That game's Candy went on a Gengar ex one card before Hilda brought the Mega.
- ***Fainting Spell* is live.** It took a 3-Prize Zygarde in that game.
- ***Nullifying Zero*** costs five Energy and flips a coin for each of your Pokémon, 150 on every heads. It is their late-game Bench wipe, and a small Bench limits it.

### Versus Cynthia's Garchomp ex
...
| Their number | Your answer |
| :--- | :--- |
| *Maximum Drilling*: 200 with three Energy, 330 with five | the Mega at 350 and a Cape'd Gengar ex at 380 both survive 330 |
...
| Their number | Your answer |
| :--- | :--- |
| *Powerful Hand*: 2 counters on your Active per card in their hand, from a 140 HP Stage 2 with no Rule Box | a race; neither Concealment nor *Fainting Spell* ever applies |
| Alakazam 140, Kadabra 80, Abra 50, all weak to Darkness | an un-Poisoned *Chain-Crazed* doubles to 260; *Chaotic Pain* kills Abra and Kadabra, and Alakazam after a Ruins chip |
| Dunsparce into Dudunsparce, their draw | *Chaotic Pain* the Dunsparce |
...
| Their number | Your answer |
| :--- | :--- |
| *Night Joker* copies a Benched N's Pokémon's attack for two Energy; N's Zekrom's *Rampaging Thunder* is 250 | Gengar ex at 280 survives 250 |
...
| Their number | Your answer |
| :--- | :--- |
| *Punk Up* attaches up to five Energy when it evolves; *Shadow Bullet* is 180, plus 30 to your Bench | Gengar ex and the dog both survive one; neither survives two |
...
- **Kill order: Munkidori, then Froslass, then Grimmsnarl.** Damage on Grimmsnarl doesn't stick while a Munkidori lives, because they move it onto you. In the Live loss, 90 of the dog's 260 came back that way.
- **Munkidori is weak to Darkness.** Boss's Orders plus any real attack kills it, so you don't need a Gengar in play to answer it.
...
| *Matcha Spin* (six in the discard) puts 4 counters on each of your Pokémon; *Spiritual End* (thirteen) quadruples the counters on two of them | keep counters off your board |
| Eevee into Espeon, whose *Miraculous Shine* devolves every evolved Pokémon you have | kill the Eevee first |
...
| Their number | Your answer |
| :--- | :--- |
| *Mysterious Rock Inn*: Crustle takes no damage from your Pokémon ex | counters aren't damage, and your non-ex Pokémon still hit it |
| Crustle 150, or 170 with Growing Grass Energy; Dwebble 70 | a Pain plus Haunter's *Spooky Shot* (40) kills either |
| Mist Energy: no effects of your attacks on the Pokémon holding it | *Chaotic Pain* can't touch it; Toxtricity's *Gentle Slap* (100) still can |
| Mega Kangaskhan ex, a 300 HP Basic: *Rapid-Fire Combo* is 200, plus 50 per heads | a dog plus *Gentle Slap* or *Void Gale* |
| *Superb Scissors*: 120 | Gengar ex survives two |
...
- **Shoot Crustle before the Mist lands.** *Superb Scissors* costs [G][C][C], so an attacking Crustle usually holds a Mist Energy, and then *Chaotic Pain* can't touch it. Dwebble and a Crustle still waiting on Energy are the targets. Read the Energy before you pick.
- **Your non-ex Pokémon are the attackers.** Rock Inn only stops Pokémon ex. *Gentle Slap* does 100, Haunter's *Spooky Shot* does 40 for one Energy, and Toxel's *Playful Kick* adds 20.
- **Spiky Energy hits back.** Damage their Active while it holds one and your attacker takes 2 counters. One Slap leaves Toxtricity at exactly 120, which *Superb Scissors* kills.
...
| Their number | Your answer |
| :--- | :--- |
| *Rumbling Bees*: 110 for each Beedrill in play, for one Grass Energy | 330 at three and 440 at four; the Mega survives three |
| Forest of Vitality: Weedle to Beedrill ex on the turn it is played | no cradle ever sits on their Bench for a Pain |
| Beedrill ex 310, Weedle 50, Kakuna 80 | a Pain plus a dog swing or *Void Gale* for each Beedrill |
| Dunsparce into Dudunsparce, drawing three a turn | Dunsparce has to sit a turn, and Forest doesn't help it |

- **Shoot the draw, not the bees.** Every Dunsparce you kill is three cards they don't draw next turn.
- **Stranded Weedle and Kakuna are free.** When they bench a Weedle without the evolutions in hand, it sits a turn. Kakuna's *Exoskeleton* only reduces attack damage, so counters go straight through.
- **Every Beedrill you Knock Out takes 110 off their attack.**
- **Risky Ruins is a tax, not a lock.** They run four Forests, and Celebi searches for more.
- **The dogs are weak to Fighting, not Grass,** so two bees (220) don't kill one.

### Versus Mega Starmie ex

| Their number | Your answer |
| :--- | :--- |
| Mega Starmie ex: a Stage 1 from Staryu (70), 330 HP, online on their second turn | going second, you can't reach the Staryu in time |
| *Jetting Blow*: 120, plus 50 to one of your Benched Pokémon, for one Energy | two hits kill a Gastly or Toxel |
| *Nebula Beam*: 210, ignoring every effect | Okidogi at 250 and Gengar ex at 280 both survive it |

- **Race it with the dog.** *Musculature* on turn 1 and *Chain-Crazed* for 260 on turn 2 leave Starmie at 70, and one *Chaotic Pain* takes their Mega for 3 Prizes.
- **Don't Surge a Gastly in this room.** *Jetting Blow*'s 50 plus Surge's 20 is exactly 70.
- **Mega first,** since they attack with a Pokémon ex.

### Versus Mega Floette ex

| Their number | Your answer |
| :--- | :--- |
| Mega Floette ex: a 250 HP Basic, 400 with Ange Floette in play | Risky Ruins replaces Ange Floette, and it drops back to 250 |
| *Eternity Bloom*: 200, plus four Energy onto their Bench | Gengar ex survives one hit |
| Weakness is Metal, not Darkness | nothing doubles |

- **At 400, only two things kill it in one go.** *Fainting Spell* did it on Live. The other is replacing Ange Floette and then swinging *Chain-Crazed* for 260.
- **Latias ex gives their Basics free retreat, and Munkidori shows up here too.** Munkidori stays priority one.
- **Mega first**, since their attacker is a Pokémon ex.

### Versus Toxtricity Box

| Their number | Your answer |
| :--- | :--- |
| Crushing Hammer, four copies | take both from *Musculature*, and keep a Recycler |
| Fezandipiti ex: *Cruel Arrow* does 100 to any one of your Pokémon | the Bench isn't safe, so a doomed dog swings first |
...
| Munkidori, Unfair Stamp, Special Red Card | *Chaotic Pain* the Munkidori; bench what you draw |
...
- **Use their Team Rocket's Factory.** Your Petrel is a Team Rocket's Supporter, so their Stadium draws you two.
- **Mew ex needs damage, not counters.** *Chaotic Pain*'s 130 falls short of 160; a dog or *Void Gale* one-shots it.

### Versus Mega Sharpedo ex

| Their number | Your answer |
| :--- | :--- |
| *Hungry Jaws*: 120 for two Energy, 270 once Sharpedo has any damage counters | Gengar ex at 280 and the Mega at 350 survive it |
| Binding Mochi: +40 while Sharpedo is Poisoned, and Pecharunt ex's *Subjugating Chains* Poisons it on purpose | 310, which kills a Gengar ex without the Cape |
| Mega Sharpedo ex: 330 HP, Retreat 0, Stage 1 from Carvanha (70) | a dog plus a Pain, and every counter they put on it counts toward yours |
| Their own Toxtricity, and Munkidori moving 3 counters a turn onto you | *Chaotic Pain* the Munkidori, then their Toxel |
...
- **Kill order: Munkidori, then their Toxel.** Moved counters skip Concealment and *Fainting Spell*, and 3 a turn put the Mega in range of 310. Once their Toxel evolves, Toxtricity (140) takes a dog.
- **Gengar ex first, per the Munkidori rule.** Then the Mega, since Sharpedo and Pecharunt ex are both Pokémon ex.
- **The Cape goes on Gengar ex.** At 380 it clears the Poisoned 310; the Mega at 350 already does.
- **Their counters are your damage.** Surge's 20, Carvanha's recoil, and Poison all stay on the Sharpedo. One carrying 70 dies to a single dog swing.
...
- **Going second, you can't reach the Carvanha in time**, the same as Starmie. Race with the dog.
...
| Their number | Your answer |
| :--- | :--- |
| *Energized Slap*: 40 for every Energy on Cinccino, for one Energy | 7 Energy kills a Gengar ex, 9 the Mega, 10 a Cape'd Gengar ex |
| *Smooth Coat*: a coin on every attack's damage, and heads prevents it | counters aren't damage, so *Chaotic Pain* never flips |
| Cinccino ex 240, Minccino 70 | two Pains, or one on the Minccino |
| Online lists load it with Metang's *Metal Maker* | *Chaotic Pain* the Metang, the same as against Excadrill |
...
- ***Chaotic Pain* is the attack.** Every dog swing is a coin flip against *Smooth Coat*, and two Pains kill Cinccino ex with no flip at all.
- **Kill it early.** Its damage grows every turn it lives, and its 240 HP doesn't. Two Pains kill it at two Energy or at fifteen.
- **If it is their only Pokémon, a Knock Out wins the game.** A player with nothing left in play loses on the spot, whatever the Prizes say.
- **Mega first.** Cinccino ex is a Pokémon ex, so Concealment works, and *Fainting Spell* is an Ability that *Smooth Coat* can't flip away.
- **Metang before Cinccino when both are up.** Every Metang is roughly one more Energy a turn.

### Versus Charizard and Battle Cage

| Their number | Your answer |
| :--- | :--- |
| Battle Cage: no counters on their Benched Pokémon | Risky Ruins replaces it, and Petrel finds the Ruins |
...
| Symptom | Fix |
| :--- | :--- |
| The first attack keeps arriving late | 2nd Janine's Secret Art over the 2nd Boss's Orders. In the simulator it was worth about a point of first-attack speed and two points of Gengar speed by turn 5. |
| Alakazam keeps winning | Unfair Stamp over Hero's Cape. Their damage is their hand. |
| Hands dry up mid-game | 4th Lillie's Determination over the 2nd Boss's Orders |
| Lone-Basic openings still cost games | 3rd Poke Pad over a Dawn |
| Mulligans still hurt | 4th Okidogi ex over the 2nd Hilda: 12 Basics and a 19% mulligan |
| Stage 2s never arrive | 3rd Haunter over a Grimsley's Move |
| Grimsley's keeps missing | Count the targets first ([odds](#grimsleys-move-odds)). If it still misses, 3rd Dawn over a Grimsley's. |
| Crushing Hammer rooms drain you | 11th Basic Darkness Energy over a Risky Ruins |
| Energy runs out late anyway | Energy Retrieval over a Switch |
| Jamming Tower keeps turning the Cape off | 3rd Risky Ruins over a Switch |
| Single-Prize decks keep winning the race | the Perfect Order Gengar over a Toxel; see [Alternatives](#alternatives) |
| The Mega keeps getting dragged up in single-Prize rooms | not a card problem; leave it in the deck, per [the rule](#which-stage-2-gets-the-candy) |
...
| :--- | :--- | :--- |
| Janine's Secret Art, the 2nd | the 2nd Boss's Orders | the first attack keeps arriving late; see [Test and Tune](#test-and-tune) |
