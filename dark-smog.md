...
**One attack scales off your own board, and every card in the deck is a legal target for it.**
...
> [!IMPORTANT]
> **This deck does not care which Fox shows up.** That is the whole reason it exists. Build [Shadow Syndicate](./dark-rocket.md) when you know he is on ex, and build this when you do not.
...
> [!WARNING]
> **Prime Catcher is this deck's one ACE SPEC.** You own the Japanese copy from the MEGA Starter Set, so it costs nothing. Scramble Switch or Legacy Energy could take the slot, but never two of them.

> [!NOTE]
> **Regulation marks D through J.** This is a kitchen table deck and it is not Standard legal. Galarian Weezing, Evolution Incense, and Nest Ball all rotated. That is fine here and it is deliberate; the two Galarian Weezing are the reason this deck works.
...
130 HP, Stage 1, evolves from Team Rocket's Koffing only.

- ***Explode Together Now*** [D][C] for 40x. 40 damage for each Pokémon in play with "Koffing" or "Weezing" in its name, both yours and your opponent's. It counts itself.
...
### Galarian Weezing (Chilling Reign · E)

***Energy Factory*** makes each basic Darkness Energy attached to your Pokémon that have "Weezing" in their name provide two Darkness. You cannot apply more than one at a time, so the second copy is insurance, not a doubling.
...
### Galarian Weezing (Shining Fates · D)

***Neutralizing Gas*** turns off every Ability your opponent has in play, for as long as this is your Active Pokémon. Your own Abilities are untouched.

- ***Severe Poison*** [D] poisons for 4 damage counters per Pokémon Checkup instead of 1. That is 40 a turn from a one-Energy attack.

Retreat is 3, so committing to this is a decision, not a pivot. Bring it up when his deck is doing something you need to stop, and accept the turn you spend not attacking.

### Team Rocket's Koffing

***Smog Signals*** fires when this is Active and takes damage from an attack, explicitly including the attack that knocks it out. Search your deck for up to 2 Pokémon with "Koffing" in their name and put them onto your Bench.
...
### Weezing (Journey Together · I)

- ***Pervasive Gas*** [D] for 30, and confuses.
- ***Crazy Blast*** [C][D] for 50, or **170** if this Pokémon used *Pervasive Gas* on your last turn.

Under *Energy Factory* both attacks cost one card. The two turn sequence is worth it when your board is small; once you have five bodies out, the 40x beats it.

### Weezing (Scarlet & Violet 151 · G)

- ***Let's Have a Blast*** flips a coin when this is knocked out in the Active Spot, and on heads the attacking Pokémon is knocked out too.
- ***Spinning Fumes*** [C][C] for 50, plus 10 to each of their Benched Pokémon.

### Gwynn

Discard up to 2 Pokémon without a Rule Box from your hand and draw 3 for each. This deck has no Rule Boxes at all, so this is always a live draw 6 as long as you are holding two spare Pokémon, which you usually are.

### Dark Bell

Both Active non-Darkness Pokémon become Confused. Yours never is one, so this is a one-sided Item.

### Prime Catcher

Gust one of their Benched Pokémon up, then switch your own Active for free. The free switch matters more here than it looks, because Team Rocket's Weezing retreats for 2 and Galarian Weezing retreats for 3.
...
| Koffing and Weezing in play | Damage |
| --- | --- |
| 3 | 120 |
| 4 | 160 |
| 5 | 200 |
...
| Galarian Weezing, *Severe Poison* | [D] | 40 per Checkup |
| Weezing, *Spinning Fumes* | [C][C] | 50, plus 10 to each Benched |
...
### 2. Get Energy Factory down early
...
### 5. Crazy Blast when the board is thin
...
**Everything is Fighting weak.** All eighteen Pokémon are Darkness with Fighting ×2. There is no second weakness the way [Shadow Syndicate](./dark-rocket.md) has one, and no tech in the deck answers it.
