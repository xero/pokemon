...
>
> A Standard-legal 60 that puts Gengar and Chandelure, favorites one and two, on the same mat with jobs that reference each other. This is the third version of [Phantom Toll](./phantom-toll.md), rebuilt from the [TCG Live](https://tcg.pokemon.com/en-us/tcgl/) games of late August 2026 after a Live variant of that list showed exactly where the deck stalls. The Toll page stays as the record of the v2 build; this page is the one to sleeve. It is built for the TCG Live ladder, so every Standard-legal card was on the table and ownership never decided a slot; the buy table at the bottom is only what the paper copy would cost. The Chandelure half still descends from [Psychic Lanterns](./psychic-lanterns.md), the Gengar half comes out of the binder, and the borrowed Rocket trainers are gone.
>
> Gourgeist, favorite three, is not in the 60, and [Where Gourgeist Went](#where-gourgeist-went) owes him the explanation. Game words are defined in [the table rules](./rules.md), and the ex-format habits live in [How To Play ex Style](./rules.md#how-to-play-ex-style).

---

> ### Table of Contents
>
> [What Changed in v3](#what-changed-in-v3) · [What The Research Says](#what-the-research-says) · [Deck List](#deck-list)
>
> **Pokémon** — [Litwick](#litwick) · [Lampent](#lampent) · [Mega Chandelure ex](#mega-chandelure-ex) · [Gastly](#gastly) · [Haunter](#haunter) · [Mega Gengar ex](#mega-gengar-ex) · [Gengar](#gengar) · [Munkidori](#munkidori) · [Fezandipiti ex](#fezandipiti-ex)
> **Supporters** — [Lillie's Determination](#lillies-determination) · [Dawn](#dawn) · [Boss's Orders](#bosss-orders) · [Janine's Secret Art](#janines-secret-art) · [Lana's Aid](#lanas-aid)
> **Items** — [Ultra Ball](#ultra-ball) · [Buddy-Buddy Poffin](#buddy-buddy-poffin) · [Rare Candy](#rare-candy) · [Wondrous Patch](#wondrous-patch) · [Switch](#switch) · [Prime Catcher](#prime-catcher)
> **Tool & Stadium** — [Gravity Gemstone](#gravity-gemstone) · [Battle Cage](#battle-cage)
...
[Phantom Toll](./phantom-toll.md) is v2. The Live list that played the most games ran 21 Pokémon on 7 Basics, 14 Energy with no way to recover any of it, 16 Supporters against 9 Items, and no Switch. Every complaint from those games traces to one of those four numbers.
...
| A Mega Chandelure goes down and the second one is not ready | no rebuild plan | Patch puts the dead Mega's Energy straight onto the next one; [game plan 5](#5-the-rebuild) is the timetable. |
...
| Gengar ex as the second attacker | 1 Gengar ex, [DD] for 160 and 2 Prizes | 1 single-prize Gengar. [D] for up to 160, gives up 0 Prizes to an ex, and comes back to hand. |
...
**The number one deck on the ladder retreats for four.** Per [Limitless online play](https://play.limitlesstcg.com/decks?game=PTCG&format=standard) in August 2026, Mega Excadrill ex is the most-played deck at 7.7% of 34,788 players. It retreats for 4 and has 340 HP. One Binding Flame makes that 5, and Phantom Maze does 380. The full retreat sheet for the field is in [The Toll Math](#the-toll-math); it comes from the [pokemontcg.io](https://pokemontcg.io) card data, because the local pool snapshot strips Retreat Cost.
...
**Every deck needs a Stadium, and this one has a good reason for the one it picked.** Standard holds 26 Stadiums. Most are brand-locked or symmetric in the wrong direction here: Gravity Mountain takes 30 HP off every Stage 2, which is both Megas; Jamming Tower turns off the Gemstone; Mystery Garden draws for Psychic boards, which is also Slowking's and Alakazam's boards. Battle Cage costs this deck nothing it uses and stops the two things that were killing benched Litwicks on Live: Freezing Shroud's Checkup counters and the six Phantom Dive puts on your Bench. Two copies rather than one plus a second Stadium, because the deck that beat v3 runs more than one Castle, and a same-name Stadium is the only kind you can always play over theirs. The one Pokémon that discards a Stadium in this deck's colors is Eternatus, whose Shatter costs [DD] and the attack for the turn; a second Battle Cage is cheaper.

**Community Chandelure lists agree on the plumbing.** The Mega Chandelure lists posted in July 2026 ([TrustYourPilot's profile](https://codes4tcg.live/decks4tcg/TrustYourPilot%20VODs/yt-2026-07-15-TrustYourPilot%20VODs-lB2g1p71ABk/1), the [PokéBeach thread](https://www.pokebeach.com/forums/threads/mega-chandelure-deck.156910/), [Deltia's guide](https://deltiasgaming.com/pokemon-tcg-mega-chandelure-ex-deck-guide-pitch-black/)) run Wondrous Patch, Gravity Gemstone, Switch, and a Journey Together Grimmsnarl line whose Shadowy Knot reads the toll at 50 per [C] for one Prize. This deck takes the first three and spends the Grimmsnarl seats on the Gengar line; the Grimmsnarl is a third Stage 2 in a deck that already runs two.

> [!IMPORTANT]
> **Format check, August 2026.** Standard is regulation marks **H, I, and J**. Every card in this list carries one of the three. The seven reg-H names (Munkidori, Fezandipiti ex, Janine's Secret Art, Lana's Aid, Buddy-Buddy Poffin, Prime Catcher, Gravity Gemstone) rotate around April 2027; the Pitch Black, Phantasmal Flames, and Perfect Order core is years from the door.
...
> [!WARNING]
> **One ACE SPEC per deck.** Prime Catcher is this deck's one, and it is the **Temporal Forces print**, because the Prismatic Evolutions copy is the lanterns' and the Japanese starter copy plays at the kitchen table and nowhere else.
...
The Basic the deck stands on, and the only Psychic Litwick ever printed. Four copies now, all Pitch Black; the Live list carried a White Flare Litwick as its third, and a Fire body cannot pay Will-O-Wisp's [P] or Spreading Light's [P] after it evolves. 70 HP keeps it inside Poffin range. Going second, Will-O-Wisp for 20 is a real turn-one attack, and it is the turn that sets up the turn-two Candy.

### Lampent

**Spreading Light schedules the Megas.** Search your deck for up to 3 Lampent and bench them, and each one is a Mega Chandelure next turn with no Rare Candy spent. Three copies rather than four, so the fetch caps at 2 in practice. That is the right number now: with Munkidori and a Fezandipiti on the Bench, two Lampent fill the last seats and a third would have nowhere to sit.

### Mega Chandelure ex

**Stage 2 from Lampent. Gives up 3 Prize cards.** 350 HP, Retreat 2, Resistance to Fighting, and a Darkness Weakness the other half of this deck exists to cover.

*Binding Flame* needs no Energy and works from the Bench; every retreat the opponent pays costs one more, and every Phantom Maze hits 50 harder. **It stacks.** Two in play is plus 2 and plus 100, settled by the official Pitch Black strategy article. *Phantom Maze* itself does 130 plus 50 for each [C] in the opponent's Active Pokémon's Retreat Cost, and [The Toll Math](#the-toll-math) is the full menu, including what the current field pays. Two on the board is the number; the third copy is the rebuild, not a resident.

### Gastly

The bottom of the Gengar line, and the **Phantasmal Flames print** on purpose. The Live list ran the Temporal Forces Gastly at 60 HP; this one has 70, which is one more counter for a Munkidori to find and the difference between dying to two Adrena-Brain moves and surviving them. *Petty Grudge* is a guaranteed 10 for [D]. It is Darkness, so Janine's Secret Art can feed it and Concealment prices it at zero.

### Haunter

***Haunt* places 3 damage counters for one Energy**, and placed counters ignore Weakness and Resistance. One copy, because four Rare Candy carry the Gengar line and this is the insurance for the game where the Candy is prized or already spent. Janine's Secret Art charges it from the deck; a Haunter with a Darkness on it is 30 a turn while the Candy waits, and the Energy rides the evolution up.

### Mega Gengar ex

**Stage 2 from Haunter. Gives up 3 Prizes, and discounts everyone else's.** *Shadowy Concealment* takes 1 Prize off every Knock Out an opposing Pokémon ex scores on your Darkness Pokémon: Gastly, Haunter, and Gengar pay 0, Fezandipiti pays 1, and the Mega itself pays 2. The Psychic half gets no discount, which is exactly why the Dark wall is the cheaper wall to lose.

*Void Gale* is 230 for [DD], then **move an Energy from this Pokémon to 1 of your Benched Pokémon**. The move is mandatory, so read it as a ferry schedule, not a bonus. It is also the deck's only type-blind accelerator: the Energy it moves can be the Psychic you attached as its third, landing on a Lampent that evolves next turn, or a Darkness landing on the Munkidori that turns Adrena-Brain on. Two copies, because it is the second wall and the ferry, never the plan. [Game plan 3](#3-the-dark-button) is the timetable.

### Gengar

**The second attacker the Live games asked for, and it was already in the binder.** 130 HP, Retreat 1, Darkness, one Prize. *Mind Jack* does 10 plus 30 for each of your opponent's Benched Pokémon for a single [D]: 130 into a bench of four, 160 into a full one, which is more than Gengar ex's Tricky Steps did for two Energy and two Prizes. *Infinite Shadow* returns it to your hand when an attack Knocks it Out.
...
Shuffle your hand into your deck and draw 6; at exactly 6 Prizes remaining, draw 8. Four copies, the house number, up from the three the Live list ran. This is the card that fixes the hand; Fezandipiti is the card that refills it. The shuffle half also returns the spare Stage 2s and Patches to where Dawn and Ultra Ball can find them again.
...
Discard 2 other cards from your hand, then search your deck for any Pokémon. The only Item that finds a Mega, a Munkidori, or a Fezandipiti. The discard is not a cost here; a Psychic Energy pitched to Ultra Ball is a Wondrous Patch target the same turn, which makes Ultra Ball the second half of an attachment. Two copies, down from three to seat the second Battle Cage; Dawn and Poffin carry the rest of the searching.

### Buddy-Buddy Poffin

Bench up to 2 Basic Pokémon with 70 HP or less. Litwick and Gastly both qualify, so one Poffin seeds both engines on turn one. Munkidori at 110 and Fezandipiti at 210 do not; do not go looking for them with it. Three copies.

### Rare Candy

Litwick straight to Mega Chandelure, Gastly straight to Mega Gengar or to Gengar. Four copies serving six Stage 2s, with Spreading Light covering the Chandelure side and one Haunter covering the Gengar side when the Candy is elsewhere. The two riders bite as always: never on your first turn, and never on a Basic that was benched this turn. The fastest Phantom Maze in the deck is a Litwick benched turn one, a Psychic attached turn one, and Candy plus a second Psychic on turn two.

### Wondrous Patch

**The card the Live games were missing.** Attach a Basic Psychic Energy from your discard pile to 1 of your Benched Psychic Pokémon. It is an Item, so you may play as many as you hold. A Mega Chandelure that dies loaded leaves two Psychic in the discard; two Patches put both onto the Lampent beside it, the Candy or the evolution finishes the Mega, and it attacks the same turn. Three copies, because that rebuild has to happen on the one turn it is needed.
...
Switch your Active Pokémon with 1 of your Benched Pokémon. Two copies, zero in the Live list, and the whole reason a Gastly opener cost a turn. Bench the Litwick, attach to it, Switch it in. Switch also ignores Retreat Cost, which matters because Gravity Gemstone raises your own.
...
While the Pokémon this is attached to is in the Active Spot, **the Retreat Cost of both Active Pokémon is 1 more**. On the Mega Chandelure that plans to attack, that is plus 50 on every Phantom Maze on top of every Flame, and it is the 50 that turns 280 into 330 against Blaziken ex and Marnie's Grimmsnarl ex, and 330 into 380 against Mega Lucario ex and Mega Dragonite ex. The honest half of "both": your Active pays the extra [C] too, which is why the deck runs two Switch and keeps Prime Catcher for the exit. Jamming Tower turns it off; nothing else in the field does.

### Battle Cage

**The Stadium, and the reason the deck finally has one.** Prevent all damage counters from being placed on Benched Pokémon, both sides, by effects of attacks and Abilities from the opponent's Pokémon. Damage from attacks is still taken. Two copies.
...
| Latias ex | 210 | 2 | 280 | one Flame, and do it first; see [the card shop](#versus-the-card-shop) |
...
The discount only exists while a Mega Gengar is in play, only against attack damage, and only from a Pokémon ex. Against single-prize rooms both tables go quiet, and [the meta section](#the-meta-this-deck-lives-in) is honest about what that costs.
...
1. Turn one, bench a Gastly with the Poffin that was fetching Litwick anyway.
2. Janine's Secret Art puts one Darkness on the Gastly and one on the Fezandipiti or a second Gastly. Munkidori is a Psychic Pokémon, so it is not a legal target; its Darkness comes from the Void Gale ferry in step 4 or from a manual attachment. Nothing was manually attached to the Gengar line, so Chandelure's curve did not notice.
3. Rare Candy the Gastly into Mega Gengar. The Energy rides the evolution up.
4. One manual Dark finishes [DD]. *Void Gale* for 230, and the mandatory move ships an Energy back to the Bench: onto the next Gastly, onto a Lampent, or onto the Munkidori if the Janine's went elsewhere.

The honest print on this plan: it is a turn slower than it looks, because Janine's feeds two different Pokémon and never two onto one. Against rooms where the Gengar never leads, spend that Supporter turn on Lillie's and let the Gastly sit. It is still a Gengar in waiting.
...
- **Adrena-Brain, 30 anywhere, every turn.** Move the counters off your wounded Mega onto their Active before you attack, and a Maze that was 30 short is a Knock Out. Mega Lucario at 340 takes 330 from two Flames plus Gemstone; three counters first, and it is down.
- **Mind Jack, up to 160 for one Energy.** Gengar into a full Bench is a Mega's worth of damage from a card that pays them nothing and comes back. Lead with it against the ex decks whenever the Megas need a turn.
- **Boss's Orders and Prime Catcher.** Four gusts. The Retreat 3 and 4 bodies on their Bench are the ones the toll wants; the Dusknoir in a Dragapult list, the Dudunsparce, the Raging Bolt.
- **Cruel Arrow, 100 anywhere.** Fezandipiti's attack for three of anything, when the Void Gale ferry has left it holding Energy and something on their Bench is sitting at 100.
- **Haunt, 3 counters a turn.** A pre-Candy Haunter with a Janine's Darkness is 30 placed damage per turn that no Resistance shaves.

## 5. The Rebuild

**The first Mega Chandelure will die. This is the turn after.**

1. Their attack Knocks it Out and takes 3 Prizes. Two Psychic Energy go to your discard.
2. Your turn. *Flip the Script* draws 3.
3. Wondrous Patch, twice, onto the Lampent you seeded with Spreading Light or the Litwick you benched earlier. If it is a Litwick, Rare Candy it; if it is a Lampent, evolve it.
4. Switch or Prime Catcher it into the Active Spot. Phantom Maze, same turn, into whatever they left in front.
...
| Your hand has | Play |
| :--- | :--- |
| **Buddy-Buddy Poffin** | Play it first, always. Litwick plus Gastly is the standard fetch; two Litwick if the Gengar half is not wanted. |
| **Litwick Active and a Psychic** | Attach. Going second, Will-O-Wisp for 20. Turn two is Candy, second Psychic, Phantom Maze. |
| **Gastly Active, nothing else** | Poffin or Ultra Ball for a Litwick, attach to the Litwick, Switch next turn. Never spend the turn retreating. |
| **Dawn** | A whole line to hand. Take Litwick, Lampent, Mega Chandelure unless the room says Gengar. |
| **Ultra Ball and two Psychic** | Pitch the Psychic you cannot attach. It is a Patch away from the Bench. |
| **A bad hand** | Lillie's for the reset; at 6 Prizes it draws 8. |
| **Gastly and a Gengar in hand** | Bench the Gastly and wait. Candy is illegal turn one and on fresh Basics. |
...
| :--- | :--- |
| Janine's aimed at one Pokémon | Illegal as intended: one Energy each to two different Darkness Pokémon. |
| Forgetting Void Gale's move is mandatory | The attacking Gengar strips itself below [DD]. Every swing needs a third Energy aboard or a plan for the ferry. |
| Wondrous Patch on an empty discard | Dead card. Ultra Ball a Psychic first, or wait for the first Knock Out. |
| Wondrous Patch aimed at the Active | Illegal. It reads Benched. Charge the Bench, then Switch. |
| Munkidori with no Darkness on it | Adrena-Brain is off. Janine's cannot feed it, because it is a Psychic Pokémon; budget a manual Darkness or the Void Gale ferry for it. |
| Poffin for Munkidori or Fezandipiti | Illegal, 110 and 210 HP against a 70 cap. Ultra Ball and Dawn are the routes. |
| Rare Candy on a Basic benched this turn | Illegal. Bench the seeds one turn earlier than you think you need them. |
| First Candy spent on the Gengar line | The toll engine is late and the whole deck idles. Chandelure first, always. |
| Both Megas exposed at once | Six Prizes standing in the open, and only one of them carries a discount. Two walls is a queue, not a formation. |
| Gemstone down, no exit budgeted | Your own Active pays the extra [C] too. Switch ignores it; retreating does not. |
| Spreading Light for three | With Munkidori and Fezandipiti seated there are two chairs, not three. Fetch what you can seat. |
| Flip the Script with nothing dead | It only draws the turn after one of yours was Knocked Out, once per turn. Plan the Lillie's around it. |
| Adrena-Brain at their Bench under your own Cage | Blocked. Battle Cage reads both sides. Aim at their Active, or bump your own Cage first if the Bench shot wins the game. |
| Second Battle Cage while the first is still down | Illegal. A Stadium with the same name cannot be played. It is the answer to their Stadium, not a second copy of yours. |
| Lana's Aid for a Mega | Illegal. Rule Box Pokémon never come back with it. |

---

## The Meta This Deck Lives In

The TCG Live ladder, per [Limitless play data](https://play.limitlesstcg.com/decks?game=PTCG&format=standard), August 2026, 467 tournaments and 34,788 players.
...
**[Fox's Team Rocket's Mewtwo](./rocket-mewtwo.md).** Mewtwo ex retreats for 3, so one Flame prices it at 330 into a 280 HP body: one shot, two Prizes. His board is ex-heavy, so Concealment runs all game, and his *Assassin's Return* at 240 into Weakness is the reason the Psychic ghosts stay benched when Crobat is loaded; feed it the Dark wall instead, which takes it neutral. Gengar into his full Rocket bench is 160 for one Energy and pays him nothing.

**[Fox's Flareon ex](./fire-tournament.md).** Fire hits both halves neutral, and nothing he has one-shots a healthy 350. Flareon ex retreats for 2, so it pays 280 to one Flame and 330 to two; his Tera bench protection stops attacks, not Adrena-Brain, so the counters reach whatever they like.
...
| Card | Why not |
| :--- | :--- |
| **Gengar ex** (Temporal Forces) | *Tricky Steps* is 160 for [DD] and two Prizes; the Perfect Order Gengar is up to 160 for [D], one Prize, zero against an ex under Concealment, and it comes back. *Gnawing Curse* is real, but it lives in [Curse Toll](./dark-curse.md), where the deck is built around it. |
| **Telepathic Psychic Energy** | Its bench fetch is Poffin's job, and as Special Energy nothing in the deck ever recovers it. The Live games used the fetch in emergencies and lost the Energy every time a Mega died. Four basic Psychic and three Patches do both jobs. |
| **Shadowy Darkness Energy** | Same verdict, same reason. A Darkness that cannot be Stretchered or ferried back is a Darkness the deck loses. |
| **Hilda** | An Evolution and an Energy to hand. Ultra Ball finds the Evolution at Item speed, Lana's Aid brings back three cards, and Dawn finds three Pokémon. Three Hilda were three Supporter turns the Live list could not afford. |
| **Lana's Aid** | Three non-Rule-Box Pokémon or basic Energy from the discard. Cannot touch a Mega, and Patch attaches what Lana's only puts in hand. |
| **Team Rocket's Energy** | Provides exactly this deck's colors, and only attaches to Team Rocket's Pokémon; on anything here it discards itself. |
| **Neo Upper Energy** | Two Energy of any color on a Stage 2 pays either Mega's whole attack in one card. It is an ACE SPEC, so it costs Prime Catcher, and a toll deck sells its gust last. The one skip that is a Test and Tune row, not a verdict. |
...
| Symptom | Fix |
| --- | --- |
| Mulligans still sting | Marshadow, Pitch Black 040, as an eleventh Basic over the Haunter. *Shadowy Knot* is 30 per [C] for one Energy and one Prize; 150 into Mega Excadrill. |
| You want a Basic that attacks the turn it lands | The same Marshadow, over Munkidori. It reads the toll table for one Psychic from a Basic body. |
| Energy still runs dry | A seventh Psychic over the third Ultra Ball, or Rosa's Encouragement, Perfect Order 114, over the second Dawn: two basic Energy from the discard onto a Stage 2, live whenever you are behind on Prizes, which after a Mega dies is always. |
| Dragapult keeps surviving at 230 | Black Belt's Training over one Boss's Orders. One Flame, Gemstone, and the 40 is 320 exactly. |
| Prime Catcher rarely decides a game | Neo Upper Energy in the ACE SPEC seat. One attachment, either Mega attacks. |
| Wounded Megas keep dying loaded | Wally's Compassion over the second Switch. |
| Megas keep ending up in the discard with nothing to bring them back | Night Stretcher over Lana's Aid; the Item recovers a Mega, the Supporter recovers three of everything else. |
| Both colors keep arriving one turn late | Crispin over Lana's Aid: one attached, one to hand, from the deck rather than the discard. |
| Stadiums keep beating you anyway | A third Stadium, or Colress's Tenacity, Shrouded Fable 057: a Stadium and an Energy from the deck in one Supporter. |
